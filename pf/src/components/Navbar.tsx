    ...
    >
      <div className="h-16 flex items-center justify-center max-w-screen-2xl mx-auto w-full">
        ...
        <div className="absolute right-8 md:right-16 xl:right-32 flex items-center gap-3">
          ...
          <a href="/cv.vidun.shanuka.pdf" target="_blank" rel="noopener noreferrer" className="text-[10px] font-bold uppercase tracking-[0.3em] px-4 py-2 border border-white/20 text-white transition-all duration-300 rounded relative group">
            CV
